...
PICS = (environ.get('PICS','https://i.ibb.co/CptN59cD/photo-2025-03-16-02-50-28-7482234304131497996.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', 'https://t.me/MyAnimeEnglish') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://UlluPremium:MahZc0KhUBG4G6QK@cluster0.gohka.mongodb.net/?retryWrites=true&w=majority&appName=Cluster")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/MyAnimeContactBot')
